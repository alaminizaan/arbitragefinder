...
def calculate_arbitrage_opportunity(exchange, coin_pair, fees):
    ...
    if exchange.markets[coin_pair]['quote'] in fees['funding']['withdraw']:
        transaction_fee = fees['funding']['withdraw'][exchange.markets[coin_pair]['quote']]
    elif exchange.markets[coin_pair]['base'] in fees['funding']['withdraw']:
        transaction_fee = fees['funding']['withdraw'][exchange.markets[coin_pair]['base']]
    else:
        transaction_fee = 0
